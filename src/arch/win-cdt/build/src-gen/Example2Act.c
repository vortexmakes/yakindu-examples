...
void Example2_initial(Example2 *const me) {
	...
	RKH_TR_FWK_SIG(evB);
#if 1
	RKH_TR_FWK_FUN(Example2_initial, "initial");
	RKH_TR_FWK_FUN(Example2_ToStateAExt0, "ToStateAExt0");
	RKH_TR_FWK_FUN(Example2_StateBToStateCExt3, "StateBToStateCExt3");
	RKH_TR_FWK_FUN(Example2_CompStateToStateCExt5, "CompStateToStateCExt5");
	RKH_TR_FWK_FUN(Example2_StateAToStateALoc2, "StateAToStateALoc2");
	RKH_TR_FWK_FUN(Example2_enStateA, "enStateA");
	RKH_TR_FWK_FUN(Example2_enStateC, "enStateC");
	RKH_TR_FWK_FUN(Example2_enCompState, "enCompState");
	RKH_TR_FWK_FUN(Example2_exStateA, "exStateA");
	RKH_TR_FWK_FUN(Example2_exCompState, "exCompState");
	RKH_TR_FWK_FUN(Example2_isCondStateCToCompState4, "isCondStateCToCompState4");
#endif
}
