...
RKH_CREATE_BASIC_STATE(Seq0, NULL, NULL, &Seq0, NULL);

RKH_CREATE_BASIC_STATE(Seq1, NULL, NULL, &Seq1, NULL);

RKH_CREATE_BASIC_STATE(Seq2, NULL, NULL, &Seq2, NULL);

RKH_CREATE_BASIC_STATE(Seq3, NULL, NULL, &Seq3, NULL);

RKH_CREATE_BASIC_STATE(Seq4, NULL, NULL, &Seq4, NULL);

RKH_CREATE_BASIC_STATE(Seq5, NULL, NULL, &Seq5, NULL);

RKH_CREATE_BASIC_STATE(Failure, NULL, NULL, &Failure, NULL);
